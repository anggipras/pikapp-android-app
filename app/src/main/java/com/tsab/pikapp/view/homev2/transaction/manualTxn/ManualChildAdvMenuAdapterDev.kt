...
class ManualChildAdvMenuAdapterDev(
    val context: Context,
    ...
    var addMenuChoice: ArrayList<ManualAddAdvMenuActivity.AddAdvMenuTemp>,
    private val advMenuEdit: Boolean,
    private val listener: ManualChildAdvMenuAdapterDev.OnItemClickListener
) : RecyclerView.Adapter<ManualChildAdvMenuAdapterDev.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        if (choiceType == "RADIO") {
            ...
            holder.menuChoiceRadio.setOnClickListener { v ->
                ...
                val dummyEachData = ManualAddAdvMenuActivity.AddMenuChoicesTemp(ext_menu_name = menuChoiceList[position].ext_menu_name, ext_menu_price = menuChoiceList[position].ext_menu_price)
            ...
            val dummyEachDataCheck = ManualAddAdvMenuActivity.AddMenuChoicesTemp(ext_menu_name = menuChoiceList[position].ext_menu_name, ext_menu_price = menuChoiceList[position].ext_menu_price)
            val dummyEachDataCheckRemoved = ManualAddAdvMenuActivity.AddMenuChoicesTemp(ext_menu_name = "", ext_menu_price = "0")
