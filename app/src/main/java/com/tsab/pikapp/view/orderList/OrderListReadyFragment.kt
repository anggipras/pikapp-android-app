...
import com.tsab.pikapp.databinding.FragmentOrderListReadyBinding
import com.tsab.pikapp.view.OrderListActivity
import com.tsab.pikapp.viewmodel.orderList.OrderListCohortViewModel

class OrderListReadyFragment : Fragment(), OrderListCohortAdapter.OrderListInterface {

    private lateinit var dataBinding: FragmentOrderListReadyBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,savedInstanceState: Bundle?): View? {
        dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_order_list_ready, container, false)
