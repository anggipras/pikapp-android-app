...
class AdvanceMenuDetailsSortAdapter(
    val menuChoiceList: MutableList<AdvanceAdditionalMenu>
) : RecyclerView.Adapter<AdvanceMenuDetailsSortAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: AdvanceMenuDetailsSortAdapter.ViewHolder, position: Int) {
        holder.menuChoiceName.text = menuChoiceList[position].ext_menu_name
        holder.menuChoicePrice.text = "Rp ${menuChoiceList[position].ext_menu_price}"
    }
