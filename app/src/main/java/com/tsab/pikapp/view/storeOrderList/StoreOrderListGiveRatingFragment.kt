...
import com.tsab.pikapp.databinding.FragmentStoreOrderListGiveRatingBinding
...
class StoreOrderListGiveRatingFragment : Fragment(), StoreOrderListCohortAdapter.StoreOrderListInterface {

    private lateinit var dataBinding: FragmentStoreOrderListGiveRatingBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_store_order_list_give_rating, container, false)
